...
public class LevelGenerator : MonoBehaviour {
    ...
    private void Start()
    {
        ...
        // 在選取到的位置上生成房間
        //int randBeginRoom = Random.Range(0, beginRoom.Length);這個先註解掉...這是用來生成"起始房間"之後會補。
        //生成"起始房間"
        Instantiate(beginRoom[0], transform.position,Quaternion.identity);
        //隨機給個生成房間的"方向"
    ...
    private void Move()
    {
            ...
            else if (direction == 5)// 往下生成房間 !!
            {
                ...
                if (transform.position.y > minY)
                {
                    ...
                    //如果不是 index 1 & index 3 的房間，毀掉那個房間，再生成index 1 或是 index 3的房間。
